...
public class UrbanagerApp extends Application<UrbanagerConf> {
  ...
  private final String VERSION_CONFIG = "0.0.1";
  private final String VERSION_PATH = "/api";
  ...
  private void prepareSwaggerApiListingResource(final Environment environment) {
    ...
    config.setVersion(this.VERSION_CONFIG);
    config.setBasePath(this.VERSION_PATH);
